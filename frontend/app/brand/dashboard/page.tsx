  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-6">
        ...
        <Link href="/brand/campaigns/new" className="btn-primary">+ New Campaign</Link>
      </div>
      ...
      {!isLoading && !error && campaigns?.length === 0 && (
        <div className="text-center py-12">
          ...
          <Link href="/brand/campaigns/new" className="btn-primary">Create your first campaign</Link>
        </div>
      )}
        ...
        {campaigns?.map((c) => (
          <div key={c.id} className="card">
            <div className="flex justify-between items-start">
              ...
              <Link href={`/brand/campaigns/${c.id}`} className="btn-text">View →</Link>
            </div>
          </div>
        ))}
      </div>
