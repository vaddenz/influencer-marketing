  ...
  return (
    <div>
            ...
            <div key={i.id} className="card">
              <div className="flex justify-between items-start">
                ...
                <div className="flex gap-2">
                  <button
                    onClick={() => respondMutation.mutate({ id: i.id, action: 'accept' })}
                  ...
                  <button
                    onClick={() => respondMutation.mutate({ id: i.id, action: 'decline' })}
                    disabled={respondMutation.isPending}
                    className="btn-secondary text-sm"
                  >
                    {respondMutation.isPending ? '...' : 'Decline'}
                  </button>
                </div>
              </div>
            </div>
      ...
      {respondMutation.isError && (
        <div className="mb-6 p-4 bg-red-50 text-[var(--c-error)] rounded-lg text-sm">
